...
public final class SurveySerializer {
    ...
    public static class Survey {
        ...
        public Survey(List<Sample> samples, List<Segment> segments, String dest_command, String dimension, String player_uuid, String player_name) {
    ...
    public static void writeSurveyFile(List<Sample> samples, List<Segment> segments, String destCommand, String dimension, String playerUuid, String playerName) throws IOException {
        Gson gson = new GsonBuilder().setPrettyPrinting().create();
        Survey survey = new Survey(new ArrayList<>(samples), new ArrayList<>(segments), destCommand, dimension, playerUuid, playerName);
